...
public class RewardEntityMapper {
    ...
    public static RewardEntity toEntity(Reward reward) {
        return new RewardEntity(reward.getRewardName(), reward.getRewardDescription(), reward.getRewardType(), reward.getValueInPoints());
    }

    public static Reward toReward(RewardEntity rewardEntity) {
        return new Reward(rewardEntity.getRewardName(), rewardEntity.getRewardDescription(), rewardEntity.getRewardType(), rewardEntity.getValueInPoints());
    }
}
