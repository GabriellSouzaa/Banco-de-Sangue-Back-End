...
public class DonorEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "doador_id_seq")
    @SequenceGenerator(name = "doador_id_seq", sequenceName = "doador_id_seq", allocationSize = 1)
